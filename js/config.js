...
export const initialWorldState = {
    ...
    currentBoss: null,
    bossDefeatedCount: 0,
    // Participantes del raid actual (trackea daño y participación)
    raidParticipants: [],
...
// Jefes de Mazmorra - 15 jefes épicos y mitológicos con elementos únicos, dificultad escalada y loot mejorado
export const dungeonBosses = [
    // Jefes originales (Nivel 10-50) - DIFICULTAD MEJORADA
    {
        ...
        emoji: "🧙",
        lootTable: ["epico", "raro", "raro"] // Tier de loot posible
    },
    {
        ...
        emoji: "🐉",
        lootTable: ["legendario", "epico", "epico"]
    },
    {
        ...
        element: ELEMENTS.DARK.name,
        emoji: "👿",
        lootTable: ["legendario", "legendario", "epico"]
    },
    {
        ...
        element: ELEMENTS.DARK.name,
        emoji: "🌌",
        lootTable: ["legendario", "legendario", "legendario"]
    },
    
    // Nuevos Jefes Épicos (Nivel 5-75) - DIFICULTAD EXTREMA
    {
    ...
    },
    {
        ...
        emoji: "🌙",
        lootTable: ["epico", "raro", "raro"]
    },
    // JEFE FINAL ULTRA PODEROSO
    {
        name: "Aetheros el Destructor",
        level: 80,
        hp: 30000,
        atk: 320,
        def: 220,
        ...
        goldReward: 20000,
        dropChance: 1.0,
        description: "La entidad más poderosa, solo los héroes legendarios pueden enfrentarlo",
        tier: "legendario",
        element: ELEMENTS.LIGHT.name,
        emoji: "⚡",
        lootTable: ["legendario", "legendario", "legendario", "legendario"]
    }
];
